        ...
        <div className='flex justify-center items-center'>
            <div className="card w-96 bg-base-100 shadow-xl">
                <div className="card-body">
                    <h2 className="text-center text-primary text-3xl font-bold">Register</h2>
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <input className='btn btn-primary text-white w-full max-w-xs mt-2' type="submit" value='SIGN UP' />
                    </form>
